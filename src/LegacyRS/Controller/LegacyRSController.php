    ...
    implements ServerSideAnalyticsUserInterface, ServiceLocatorAwareInterface
{
    ...
    private function runScript($fileName)
    {
        ...
        # Get variables in script namespaces (now method namespace) into the global namespace
        # As of (approximately) @5352
        ...
        # As of @6488
        global $hide_failed_reset_text,$body_classes,$slideshow_big,$team_user_filter_top,$remove_resources_link_on_collection_bar,$merge_filename_with_title,$collection_share_expire_never,$resource_share_expire_never,$resource_share_expire_days,$comments_view_panel_show_marker,$download_id_only_with_size,$search_sql_force_field_index_check,$plupload_widget_thumbnails,$plupload_widget,$related_resources_title_trim,$clear_button_unchecks_collections,$show_access_on_upload,$override_access_default,$relate_on_upload_default,$store_uploadedrefs,$share_resource_as_collection,$contact_sheet_link_on_collection_bar,$zipped_collection_textfile_default_no,$videojs,$linkedheaderimgsrc,$slimheader,$header_link_width,$header_link_height,$system_architect_user_names,$orientation,$footerspace,$lean_preview_generation,$notify_on_resource_change_days,$password_reset_mode,$allow_password_email,$stemming,$descthemesorder,$usergroupemails,$browser_language,$manage_request_admin,$allow_custom_access_share,$customgroupaccess,$autorotate_ingest,$send_collection_to_admin,$slideshow_photo_delay,$date_d_m_y,$relate_on_upload,$related_resource_preview_size,$resourcetoolsGT,$customContents,$default_customaccess,$auto_order_checkbox_case_insensitive,$save_errors,$show_error,$merge_filename_with_title_default,$baseurl,$url,$group,$restype_oder_by,$restype_sort,$find,$allfields,$field_types,$url_params,$resource_types,$introtext,$filter_by_parent,$filter_by_permissions,$resource_type_array,$ignore_collection_access,$collection_share_expire_days,$collection_share_expire_never;
