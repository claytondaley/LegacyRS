    ...
    public function indexAction()
    {
        ...
        if (file_exists($page)) {
            ...
            if ($extension == 'php'){
                ...
                if ($ajax) {
                     $title = ajax_title($output);
                } else {
                     $title = page_title($output);
                };
